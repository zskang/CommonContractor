...
//下拉分页插件
Cabletech.Ext.PagingComBo = Ext.extend(Ext.PagingToolbar, {
	...
	onLoad : function(store, r, o) {
		...
		Cabletech.Ext.PagingComBo.superclass.onLoad.apply(this, arguments);
	},
	updateInfo : function() {
		if (this.displayItem) {
...
Ext.ux.PagingComBo = Cabletech.Ext.PagingComBo;
