...
Ext.extend(Ext.ux.grid.Search, Ext.util.Observable, {
	...
	onRender : function() {
		...
		this.field = new Ext.form.TwinTriggerField({
					width : this.width,
					emptyText : '输入查询条件模糊查询',
					selectOnFocus : undefined === this.selectOnFocus
							? true
							: this.selectOnFocus,
					trigger1Class : 'x-form-clear-trigger',
					trigger2Class : this.minChars
							? 'x-hidden'
							: 'x-form-search-trigger',
					onTrigger1Click : this.minChars
							? Ext.emptyFn
							: this.onTriggerClear.createDelegate(this),
					onTrigger2Click : this.onTriggerSearch.createDelegate(this),
					minLength : this.minLength
				});
		this.field.on('render', function() {
					this.field.el.dom.qtip = this.minChars
							? String
